...
class Event extends Model
{
    ...
    protected $fillable = ['title','slug','description','start_date','end_date','daily_start_time','daily_end_time','timezone','status','venue_name','venue_address','venue_lat','venue_lng','venue_how_to_get','poster_image','logo','video_url','gallery','social_links','contact_email','contact_phone','registration_type','registration_url','yandex_form_url','is_registration_open','media_image','media_description','is_media_visible','created_by'];

    protected function casts(): array
    {
        return ['start_date'=>'date','end_date'=>'date','daily_start_time'=>'string','daily_end_time'=>'string','venue_lat'=>'decimal:7','venue_lng'=>'decimal:7','gallery'=>'array','social_links'=>'array','is_registration_open'=>'boolean'];
    }
