...
function scheduleApp() {
  return {
    ...
    days: [
      {
        label: 'День первый: Энергия старта',
        dateFull: '22 июня 2026',
        dateShort: '22 июн',
        date: new Date(2026, 5, 22),
        events: [
          { time: '08:00–09:30', title: 'Завтрак', icon: '🍽️', speaker: '', location: 'Ресторан отеля', detail: '' },
          { time: '09:30–11:00', title: 'Пленарная сессия: «Стратегия развития энергетической отрасли до 2030 года»', icon: '🎤', speaker: 'Иванов А.С. – председатель оргкомитета', location: 'Зал «Юпитер»', detail: '150 участников' },
          { time: '11:00–11:30', title: 'Кофе-брейк', icon: '☕', speaker: '', location: 'Фойе зала «Юпитер»', detail: '' },
          { time: '11:30–13:00', title: 'Параллельные секции: «Цифровизация и ИИ в энергетике»', icon: '💻', speaker: 'Петров В.М. – CEO TechEnergy', location: 'Залы «Сатурн», «Венера»', detail: 'Три трека' },
          { time: '13:00–14:00', title: 'Обед', icon: '🍽️', speaker: '', location: 'Ресторан отеля', detail: '' },
          { time: '14:00–15:30', title: 'Мастер-класс: «Управление инновационными проектами»', icon: '🛠️', speaker: 'Сидорова Е.К. – директор Инновационного центра', location: 'Зал «Юпитер»', detail: 'Практическая работа в группах' },
          { time: '15:30–17:00', title: 'Панельная дискуссия: «Молодёжные инициативы: от идеи к реализации»', icon: '🎙️', speaker: 'Модератор — Козлов Д.А.', location: 'Зал «Юпитер»', detail: '5 спикеров' },
          { time: '18:30–21:00', title: 'Ужин. Вечер нетворкинга', icon: '🍽️', speaker: '', location: 'Ресторан отеля / Патио', detail: 'Музыкальное сопровождение' }
        ]
      },
      {
        label: 'День второй: Технологии',
        dateFull: '23 июня 2026',
        dateShort: '23 июн',
        date: new Date(2026, 5, 23),
        events: [
          { time: '08:00–09:30', title: 'Завтрак', icon: '🍽️', speaker: '', location: 'Ресторан отеля', detail: '' },
          { time: '09:30–11:00', title: 'Лекция: «Возобновляемые источники энергии: тренды и перспективы»', icon: '🌱', speaker: 'Смирнова О.В. – канд. техн. наук', location: 'Зал «Юпитер»', detail: '' },
          { time: '11:00–11:30', title: 'Кофе-брейк', icon: '☕', speaker: '', location: 'Фойе зала «Юпитер»', detail: '' },
          { time: '11:30–13:00', title: 'Кейс-стади: «Внедрение smart-grid технологий»', icon: '⚡', speaker: 'Кузнецов Р.А. – директор по цифровизации', location: 'Зал «Юпитер»', detail: 'Разбор реальных кейсов' },
          { time: '13:00–14:00', title: 'Обед', icon: '🍽️', speaker: '', location: 'Ресторан отеля', detail: '' },
          { time: '14:00–15:30', title: 'Воркшоп: «Разработка прототипа энергетического решения»', icon: '🔧', speaker: 'Команда наставников', location: 'Залы «Сатурн», «Венера»', detail: 'Работа в командах' },
          { time: '15:30–17:00', title: 'Презентация лучших проектов: хакатон «Энергия будущего»', icon: '🏆', speaker: 'Жюри из экспертов отрасли', location: 'Зал «Юпитер»', detail: '7 финальных команд' },
          { time: '18:30–21:00', title: 'Ужин. Квиз «Энерго-викторина»', icon: '🍽️', speaker: '', location: 'Ресторан отеля / Зал «Сатурн»', detail: 'Командное соревнование' }
        ]
      },
      {
        label: 'День третий: Лидерство',
        dateFull: '24 июня 2026',
        dateShort: '24 июн',
        date: new Date(2026, 5, 24),
        events: [
          { time: '08:00–09:30', title: 'Завтрак', icon: '🍽️', speaker: '', location: 'Ресторан отеля', detail: '' },
          { time: '09:30–11:00', title: 'Тренинг: «Эмоциональный интеллект лидера»', icon: '🧠', speaker: 'Волкова Н.П. – бизнес-психолог', location: 'Зал «Юпитер»', detail: 'Интерактивная форма' },
          { time: '11:00–11:30', title: 'Кофе-брейк', icon: '☕', speaker: '', location: 'Фойе зала «Юпитер»', detail: '' },
          { time: '11:30–13:00', title: 'Панельная дискуссия: «Карьерный рост в энергетике: roadmap 2026»', icon: '📈', speaker: 'HR-директора крупнейших компаний', location: 'Зал «Юпитер»', detail: '4 спикера' },
          { time: '13:00–14:00', title: 'Обед', icon: '🍽️', speaker: '', location: 'Ресторан отеля', detail: '' },
          { time: '14:00–15:30', title: 'Мастер-класс: «Публичные выступления и презентации»', icon: '🎤', speaker: 'Белов И.Р. – тренер по коммуникациям', location: 'Зал «Юпитер»', detail: 'Практика для каждого участника' },
          { time: '15:30–17:00', title: 'Speed-Mentoring: скоростные консультации с наставниками', icon: '🤝', speaker: '10 наставников-экспертов', location: 'Патио 1, Патио 2', detail: 'Ротация по 10 минут' },
          { time: '18:30–21:00', title: 'Ужин. Творческая мастерская', icon: '🍽️', speaker: '', location: 'Ресторан отеля / Зал «Венера»', detail: 'Командные мини-проекты' }
        ]
      },
      {
        label: 'День четвёртый: Безопасность',
        dateFull: '25 июня 2026',
        dateShort: '25 июн',
        date: new Date(2026, 5, 25),
        events: [
          { time: '08:00–09:30', title: 'Завтрак', icon: '🍽️', speaker: '', location: 'Ресторан отеля', detail: '' },
          { time: '09:30–11:00', title: 'Семинар: «Техносферная безопасность на объектах энергетики»', icon: '🛡️', speaker: 'Соколов П.Д. – канд. безопасн. наук', location: 'Зал «Юпитер»', detail: '' },
          { time: '11:00–11:30', title: 'Кофе-брейк', icon: '☕', speaker: '', location: 'Фойе зала «Юпитер»', detail: '' },
          { time: '11:30–13:00', title: 'Тренинг: «Эвакуация и действия в ЧС»', icon: '🚨', speaker: 'Представитель МЧС', location: 'Территория отеля', detail: 'Практические упражнения' },
          { time: '13:00–14:00', title: 'Обед', icon: '🍽️', speaker: '', location: 'Ресторан отеля', detail: '' },
          { time: '14:00–15:30', title: 'Круглый стол: «Экологическая ответственность предприятий»', icon: '🌍', speaker: 'Экологи и руководители предприятий', location: 'Зал «Юпитер»', detail: '6 участников дискуссии' },
          { time: '15:30–17:00', title: 'Воркшоп: «Разработка плана безопасности для проекта»', icon: '📋', speaker: 'Эксперты по безопасности', location: 'Залы «Сатурн», «Венера»', detail: 'Работа в группах' },
          { time: '18:30–21:00', title: 'Ужин. Кинофильм + обсуждение', icon: '🍽️', speaker: '', location: 'Зал «Юпитер»', detail: 'Документальный фильм об энергетике' }
        ]
      },
      {
        label: 'День пятый: Нетворкинг',
        dateFull: '26 июня 2026',
        dateShort: '26 июн',
        date: new Date(2026, 5, 26),
        events: [
          { time: '08:00–09:30', title: 'Завтрак', icon: '🍽️', speaker: '', location: 'Ресторан отеля', detail: '' },
          { time: '09:30–11:00', title: 'Open Space: «Тематические треки по инициативе участников»', icon: '🗣️', speaker: 'Модераторы треков', location: 'Залы «Сатурн», «Венера», «Юпитер»', detail: '5 треков' },
          { time: '11:00–11:30', title: 'Кофе-брейк', icon: '☕', speaker: '', location: 'Фойе зала «Юпитер»', detail: '' },
          { time: '11:30–13:00', title: 'Бизнес-завтрак: «Стартапы в энергетике»', icon: '🚀', speaker: 'Основатели энергетических стартапов', location: 'Зал «Венера»', detail: 'Ограниченная вместимость' },
          { time: '13:00–14:00', title: 'Обед', icon: '🍽️', speaker: '', location: 'Ресторан отеля', detail: '' },
          { time: '14:00–15:30', title: 'Спортивные мероприятия: эстафета, волейбол, мини-футбол', icon: '⚽', speaker: '', location: 'Спортивная площадка отеля', detail: 'Командное соревнование' },
          { time: '15:30–17:00', title: 'Подготовка к церемонии закрытия. Генеральная репетиция', icon: '🎭', speaker: '', location: 'Зал «Юпитер»', detail: '' },
          { time: '18:30–21:00', title: 'Гала-ужин. Церемония награждения и закрытие слёта', icon: '🏆', speaker: '', location: 'Зал «Юпитер»', detail: 'Награждение победителей хакатона' }
        ]
      },
      {
        label: 'День шестой: Возвращение домой',
        dateFull: '27 июня 2026',
        dateShort: '27 июн',
        date: new Date(2026, 5, 27),
        events: [
          { time: '08:00–09:30', title: 'Завтрак', icon: '🍽️', speaker: '', location: 'Ресторан отеля', detail: '' },
          { time: '09:30–11:00', title: 'Рефлексия: «Что я унесу с собой?» — круг обратной связи', icon: '💬', speaker: 'Фасилитатор — Морозова А.И.', location: 'Зал «Юпитер»', detail: 'Каждый участник делится впечатлениями' },
          { time: '11:00–11:30', title: 'Кофе-брейк', icon: '☕', speaker: '', location: 'Фойе зала «Юпитер»', detail: '' },
          { time: '11:30–13:00', title: 'Планирование: «Мой дорожный план после слёта»', icon: '🗺️', speaker: '', location: 'Залы «Сатурн», «Венера»', detail: 'Индивидуальная работа' },
          { time: '13:00–14:00', title: 'Обед', icon: '🍽️', speaker: '', location: 'Ресторан отеля', detail: '' },
          { time: '14:00–15:30', title: 'Свободное время: экскурсии по окрестностям', icon: '🌿', speaker: '', location: 'Территория отеля / окрестности', detail: 'По желанию' },
          { time: '15:30–17:00', title: 'Финальный нетворкинг. Обмен контактами', icon: '📱', speaker: '', location: 'Патио / Фойе', detail: '' },
          { time: '17:00–21:00', title: 'Торжественный прощальный ужин и отъезд', icon: '🍽️', speaker: '', location: 'Ресторан отеля', detail: 'Выезд по расписанию' }
        ]
      }
    ],
